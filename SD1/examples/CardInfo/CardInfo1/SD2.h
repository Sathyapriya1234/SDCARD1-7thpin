...
public:
  File(SdFile2 f, const char *name);     // wraps an underlying SdFile
...
private:
  ...
  friend class File;
  friend boolean callback_openPath2(SdFile2&, const char *, boolean, void *); 
};
...
typedef SDLib2::File    SDFile;
typedef SDLib2::SDClass1 SDFileSystemClass;
#define SDFileSystem   SDLib2::SD2
